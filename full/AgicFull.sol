...
contract ConstantAddressesMainnet {
    ...
    address public constant AAVE_MARKET_ETH = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    address public constant AAVE_ATOKEN_ETH = 0x3a3A65aAb0dd2A17E3F1947bA16138cd37d08c04;

    address public constant AAVE_LENDING_POOL_ADDRESSES_PROVIDER = 0x24a42fD28C976A61Df5D00D0599C34c4f90748c8;

}

// File: contracts/constants/ConstantAddressesRopsten.sol



pragma solidity ^0.6.8;

contract ConstantAddressesRopsten {

    address public constant AAVE_MARKET_ETH = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    address public constant AAVE_ATOKEN_ETH = 0x2433A1b6FcF156956599280C3Eb1863247CFE675;

    address public constant AAVE_LENDING_POOL_ADDRESSES_PROVIDER = 0x1c8756FD2B28e9426CDBDcC7E3c4d64fa9A54728;
...
// Original: https://docs.aave.com/developers/developing-on-aave/the-protocol/lendingpool
...
contract Agic is ERC20, Ownable {
    ...
    function redeem(uint256 agic) public {
        ...
        require(balance >= agic, "Not so much balance");
        ...
        //利息大于1e12收取利息
        if (interest > 1e12) {
            //用户质押金额小于加上服务费的提取总额，直接从本次提取金额里取，否则取加上利息的更大值
    ...
    //Calculate percentage with 6 decimal places,rounding 0.5=1,0.4=0
