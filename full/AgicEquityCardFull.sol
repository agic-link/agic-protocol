...
contract ConstantMetadata {
    ...
    string public constant ONE_PERCENT_METADATA_URI = "1";

    string public constant THREE_PERCENT_METADATA_URI = "2";

    string public constant FIVE_PERCENT_METADATA_URI = "3";
